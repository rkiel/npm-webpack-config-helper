...
Inject CSS into the `head` tag using a `style` tag.  Add a rule to the `module.rules` for babel.  For example,
...
Extract CSS into a file.  Add a rule to the `module.rules` for babel.  For example,
